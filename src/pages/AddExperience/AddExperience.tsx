...
import {
  IAddExperienceTemplateProps,
  AddExperienceTemplate,
} from '../../ui/templates';

export const AddExperience = ({navigation}: any): ReactElement => {
  ...
  const props: IAddExperienceTemplateProps = {
    ...
    start: {
      items: [
        {key: 'Jan 2022', value: 'January 2022'},
        {key: 'Feb 2022', value: 'February 2022'},
      ],
      ...
      items: [
        {key: 'Oct 2022', value: 'October 2022'},
        {key: 'Nov 2022', value: 'November 2022'},
      ],
  ...
  return <AddExperienceTemplate {...props} />;
};
