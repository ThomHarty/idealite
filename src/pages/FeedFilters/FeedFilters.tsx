...
import { FeedFiltersTemplate, IFeedFiltersTemplateProps } from "../../ui/templates";
...
export const FeedFilters = ({ navigation }: any): ReactElement => {
    ...
    const props: IFeedFiltersTemplateProps = {
        ...
        tags: ["Design","Admin","Law","Marketing","Engineering","Photography","HR","Web Development","Apps","Social","SEO"],
