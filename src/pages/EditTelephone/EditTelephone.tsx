...
import { IEditTelephoneTemplateProps, EditTelephoneTemplate } from "../../ui/templates";

export const EditTelephone = (): ReactElement => {
    const [code, setCode] = useState<DropdownItem | undefined>({key: "+44", value: "United Kingdon (+44)"});
