...
export const FeedV2Template = ({
  ...
  useEffect(() => {
    if (showIntroCards && onIntroFinished) {
      setShowWelcome(true);
    }
        ...
        <LogoHeader>
          ...
          <>
            ...
            <SingleSwipeCard
              ...
              onSwiped={_onInstructionsSwiped}
              opacity={0.95}>
              <FeedInstructionsCard />
            </SingleSwipeCard>
            {/* no users card */}
            <SingleSwipeCard
              visible={showNoUsersCard}
            ...
            {!showIntroCards && !showRewindAdCard && (
              <FeedLoadingCard visible={loading} />
            )}
          </>
