        ...
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <View style={baseStyles.container}>
                <IconTabs
                    ...
                    tabOneContent={conversations.length > 0 ? 
                        <View style={baseStyles.conversationsContainer}>
                            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
                                <LikesHeader heading="Conversations" />
                                {conversations.map((conversation, i) => {
                                    return <MessagesListItem key={i} {...conversation} onPress={onPressConversation} />;
                                })}
                            </ScrollView>
                        </View>
                        :
                        <View style={baseStyles.noActivityContainer}>
                            <View style={baseStyles.iconContainer}>
                                <Icon name="speech" iconStyles={baseStyles.noActivityIcon} />
                            </View>
            ...
            <View style={baseStyles.ctaContainer}>
                ...
                <View style={baseStyles.ctaTextContainer}>
                    <Typography
                        text="See who else matched with you"
                        size="small"
                    />
                </View>
            </View>
