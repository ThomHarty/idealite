            ...
            <TextHeader onPressBack={onPressBack} text="Identity Verification">
                <View style={baseStyles.contentContainer}>
                    <View style={baseStyles.svgContainer}>
                        <Pressable style={baseStyles.svg} onPress={() => onPressType("passport")}>
                            <BorderedSvg
                                svg="passport"
                                size="large"
                        ...
                        <Pressable style={baseStyles.svg} onPress={() => onPressType("license")}>
                            <BorderedSvg
                                svg="license"
                                size="large"
                    ...
                    <Text style={baseStyles.headingContainer}>
                        <Typography text="Choose which document you wish to scan" size="heading2" />
                    </Text>
                </View>
            </TextHeader>
