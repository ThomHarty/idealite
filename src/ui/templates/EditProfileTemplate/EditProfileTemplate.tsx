...
const svgListOne: IBorderedSvgProps['svg'][] = [
  'arrow',
  'chemist',
  'click',
  'dollar',
...
const svgListTwo: IBorderedSvgProps['svg'][] = [
  'pencil',
  'phone',
  'pills',
  'plane',
        ...
        <ScrollView
          ...
          <Pressable onPress={onPressUpload}>
            <View style={baseStyles.avatarContainer}>
              <Image size="avatarMedium" src={avatar || DEFAULT_IMAGE} />
            </View>
          ...
          <Pressable style={baseStyles.itemContainer} onPress={onPressName}>
            <View style={baseStyles.fakeInputContainer}>
              <FakeInput label="Name" text={name} />
            </View>
            <View style={baseStyles.fakeInputIconContainer}>
              <Icon
                name="right-chevron"
                iconStyles={baseStyles.fakeInputIcon}
              />
            </View>
          </Pressable>
          <Divider />
          ...
          <Pressable style={baseStyles.itemContainer} onPress={onPressTagline}>
            <View style={baseStyles.fakeInputContainer}>
              <FakeInput label="Tagline" text={tagline} />
            </View>
            <View style={baseStyles.fakeInputIconContainer}>
              <Icon
                name="right-chevron"
          ...
          <Pressable style={baseStyles.itemContainer} onPress={onPressLocation}>
            <View style={baseStyles.fakeInputContainer}>
              <FakeInput label="Location" text={location} />
            </View>
            <View style={baseStyles.fakeInputIconContainer}>
              <Icon
                name="right-chevron"
          ...
          <View style={baseStyles.svgsContainer}>
            ...
            <ScrollView
              ...
              contentContainerStyle={{paddingLeft: 29, paddingRight: 29}}>
              <View>
                  ...
                  {svgListOne.map((svg, i) => {
                    return (
                      <Pressable
                        ...
                        onPress={() => onPressSwipeIcon(svg)}>
                        <BorderedSvg
                          svg={svg}
                          size="small"
                          active={svg === swipeIcon}
                        />
                      </Pressable>
                    );
                  })}
