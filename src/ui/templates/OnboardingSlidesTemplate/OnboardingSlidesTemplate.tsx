      ...
      return (
        <View style={baseStyles.textContainer}>
          <Animated.View
            ...
            entering={FadeInDown}
            exiting={FadeOutUp}>
            <Typography size="heading1" text={slidesText[i].heading} />
          </Animated.View>
          <Animated.View entering={FadeInDown} exiting={FadeOutUp}>
            <Typography size="text" text={slidesText[i].text} lineHeight={24} />
          </Animated.View>
        </View>
      );
    }, []);
          ...
          <LogoHeader
            ...
            <View style={baseStyles.ctaContainer}>
              <Button
                ...
                onPress={
                  activeSlide === 3 ? handleGetStarted : handleButtonOnPress
                }
              />
