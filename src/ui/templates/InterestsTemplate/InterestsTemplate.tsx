...
import { LikesHeader, LikesNonPremiumCard, RecommendedNonPremiumCard } from "../../organisms";
            ...
            <View style={baseStyles.container}>
                <IconTabs
                    ...
                    tabOneContent={likes.length > 0 ?
                        ...
                        <ScrollView scrollEnabled={isPremium} showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 110 }}>
                            <LikesHeader heading="Likes" subHeading="This month" />
                            {likes.map((like, i) => {
                                return <LikesListItem key={i} {...like} onPress={onPressLikes} />;
                            })}
                        </ScrollView>
                        </>
                        :
                    ...
                    tabThreeContent={recommended.length > 0 ?
                        <>
                        <ScrollView scrollEnabled={isPremium} showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
                            <LikesHeader heading="Recommended" />
                            {recommended.map((like, i) => {
                                return <LikesListItem key={i} {...like} onPress={onPressRecommended} />;
                            })}
                        </ScrollView>
                        {!isPremium && (
                            <View style={baseStyles.recNonPremiumContainer}>
                                <RecommendedNonPremiumCard onPressJoinNow={onPressJoinNow} />
                            </View>
                        )}
                        </>
                        :
