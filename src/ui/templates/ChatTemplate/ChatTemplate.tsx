...
import { ChatHeader, ChatInputBar, NDAInviteResponse, ReceivedChatMessage, ReceivedNDAMessage, SentChatMessage, SentNDAMessage } from "../../molecules";
                                ...
                                <View style={baseStyles.messageContainer}>
                                    ...
                                    {((item.messageType === "chat") && item.chatMessage) && (
                                        ...
                                        {item.delivery === "sent" ? (
                                            <SentChatMessage
                                                {...item.chatMessage!}
                                                readTime={index === 0 ? item.chatMessage.readTime : undefined}
                                            />
                                    ...
                                    {((item.messageType === "nda") && item.ndaMessage) && (
                                        ...
                                        {item.delivery === "sent" ? (
                                            <SentNDAMessage
                                                {...item.ndaMessage}
                                                onPress={() => onPressNDAMessage(item.ndaMessage!.id!)}
                                                readTime={index === 0 ? item.ndaMessage.readTime : undefined}
                                            />
                                        ) : (
                                            <ReceivedNDAMessage
                                                {...item.ndaMessage}
                                    ...
                                    {((item.messageType === "ndaResponse") && item.ndaResponseMessage) && (
