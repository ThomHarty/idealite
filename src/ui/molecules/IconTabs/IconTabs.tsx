...
export const IconTabs = memo(({
    ...
    return (
        ...
        <View style={baseStyles.container}>
            <Pressable onPress={() => handleChangeTab(1)} style={baseStyles.tabContainer}>
                <TabIcon
            ...
            <Pressable onPress={() => handleChangeTab(2)} style={baseStyles.tabContainer}>
                <TabIcon
            ...
            <Pressable onPress={() => handleChangeTab(3)} style={baseStyles.tabContainer}>
                <TabIcon
